...
export const CartComponent = () => {
  ...
  return (
    <div className='bg-white rounded-lg  w-full lg:w-3/5'>
                    ...
                    <div className='w-full  flex items-center gap-2 p-2 justify-end pr-2'>
                      <TrashIcon className='h-5 rounded ring-gray-700 text-[red]'/>
                      <div className='flex items-center border px-3 py rounded border-gray-500 justify-center gap-1'>
