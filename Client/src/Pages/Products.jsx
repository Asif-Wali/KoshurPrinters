...
export const Products = () => {
  ...
  const toggleDrawer = () => {
    showDrawer(!Drawer); // Toggle the state value of Drawer
  };

      return<div className=' border-2 border-cyan-800 h-screen p-8'>
              <div className='' >
              <div className="text-center ">
                <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" onClick={toggleDrawer}>
                Show navigation
                
                </button>
              </div>
              { Drawer && <div id="drawer-navigation" className=" fixed border-2 border-Primary top-22 left-0 z-40 h-96 p-4 overflow-y-auto bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
                  <h5 id="drawer-navigation-label" className="text-base font-semibold text-gray-500 dark:text-gray-400">Filter Products</h5>
                  <button type="button" data-drawer-hide="drawer-navigation" aria-controls="drawer-navigation" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 inline-flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white" onClick={toggleDrawer}>
