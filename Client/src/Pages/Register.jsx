              ...
              <div className="flex items-center justify-center w-full lg:p-12">
                <div className="flex items-center xl:p-10">
                  ...
                  <label htmlFor="TownOrVillage" className="mb-2 text-sm text-start leading-7 text-Secondary" >Town/Village*</label>
                    ...
                    <p className="text-sm leading-relaxed text-gray-900">Already have an Account ? <Link to="/login" className="font-bold text-Primary">Sign in to your Account</Link></p>
                  </form>
                </div>
              </div>
            </div>
